...
test_1 <- fcall("gf_counts()", "use 'gf_counts()' to make the frame of the plot.")
...
test_1 <- fcall("gf_point(whatever, data = CountryData)", "use gf_point() for the body of the plot")
