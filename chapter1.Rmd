...
--- type:MultipleChoiceExercise lang:r xp:50 skills:1 key:7edaec5a41
...
*** =sct
```{r}
test_function("aes", args = "color",
              incorrect_message = "Remember to set color = clarity."  )
success_msg("Good. Even though you may never have programmed before, you were still able to figure it out!")
```

--- type:MultipleChoiceExercise lang:r xp:50 skills:1 key:8553b72780
