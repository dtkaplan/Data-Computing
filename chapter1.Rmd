...
--- type:NormalExercise lang:r xp:50 skills:1  key:88bc8f8611
## Starting with Data Camp

DataCamp is a system that lets you type and modify and let's your work be evaluated so that hints can be given.

*** =instructions
- Change the value of `second_thing` so that the sum is 50

*** =solution
```{r}
first_thing <- 10
second_thing <- 20  # change this
...
## Evaluating Commands in DataCamp 
